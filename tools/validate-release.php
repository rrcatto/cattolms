...
$need(($composer['version'] ?? '') === '0.8.5', 'composer.json version must be 0.8.5.');
...
foreach (["PLATFORM_ASSET_VERSION = '0.8.5'", "\$model['navigation']", "\$model['footer_navigation']","\$admin['sections']","\$admin['section']","\$account['sections']","\$account['section']","\$company['sections']","\$company['section']",'$this->adminSections->all()','$this->accountSections->all()','$this->companySections->all()'] as $token) {
