...
$need(($composer['version'] ?? '') === '0.5.8.2', 'composer.json version must be 0.5.8.2.');
...
foreach (["PLATFORM_ASSET_VERSION = '0.5.8.2'","set('navigation'","set('footer_navigation'","\$admin['sections']","\$admin['section']","\$account['sections']","\$account['section']","\$company['sections']","\$company['section']",'$this->adminSections->all()','$this->accountSections->all()','$this->companySections->all()'] as $token) {
...
echo 'Release validation passed: Catto Learning 0.5.8.2, ' . count($pages) . " platform pages, simplified ACL/workspace/theme-sync contracts, PHP 8.5.9 target.\n";