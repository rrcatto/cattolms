...
foreach (["PLATFORM_ASSET_VERSION = '0.8.6'", "\$model['navigation']", "\$model['footer_navigation']", 'account_sections','account_section','company_sections','company_section','admin_sections','admin_section'] as $token) {
