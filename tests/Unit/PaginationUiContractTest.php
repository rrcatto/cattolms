...
final class PaginationUiContractTest extends TestCase
{
    ...
    public function testStandaloneCourseAdministrationUsesTheSharedSectionLoader(): void
    {
        $source = self::read('src/Http/Controller/AdminCourseController.php');

        self::assertStringContainsString('platformAdministration->sectionData(', $source);
        self::assertStringContainsString("'courses_page' => \$_GET['courses_page'] ?? null", $source);
        self::assertStringContainsString("'view_all_courses' => \$platformWide", $source);
        self::assertStringNotContainsString('$this->courses->adminCourses($user->id', $source);
    }
    ...
    public function testManageableCourseListIsBoundedAndCountedByOneMembershipRule(): void
    {
        ...
        self::assertStringContainsString('public function manageableCourses(int $userId, int $limit, int $offset): array', $repository);
        self::assertStringContainsString('public function manageableCoursesCount(int $userId): int', $repository);
        self::assertSame(
            2,
