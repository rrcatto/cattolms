...
Date time: 2026/08/17 23:56 SAST

Version: 0.5.7.4

Description:
Protects the HTML error-rendering contract so ordinary 4xx/5xx pages retain the current authenticated identity when authentication is still available.
*/
...
final class ErrorPageAuthenticationContractTest extends TestCase
{
    public function testHtmlErrorRendererUsesCurrentAuthenticationWhenAvailable(): void
    {
        ...
        self::assertStringContainsString("'is_platform_admin' => \$currentUser?->hasRole('ADMIN') ?? false", $source);
    }
}
