...
Description:
Regression tests for the Catto Learning 0.5.7.5 Theme SDK 3.0 contract: filesystem-only themes, platform-owned functional pages, immutable releases, direct-parent child inheritance and Factory Reset as the shipped default rather than a universal fallback.
...
final class ThemeUiContractTest extends TestCase
{
    ...
    public function testPlatformModalsAreClosedByMarkupAndUseVersionedCoreAssets(): void
    {
        ...
        $renderer = (string) file_get_contents(__DIR__ . '/../../src/View/ThemeRenderer.php');
        self::assertStringContainsString("PLATFORM_ASSET_VERSION = '0.5.7.5'", $renderer);
