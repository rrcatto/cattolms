...
Date time: 2026/09/06 22:30 SAST
...
final class CatalogueBrowseIntegrationTest extends TestCase
{
    ...
    protected function tearDown(): void
    {
        ...
        $this->db->exec('DELETE FROM tags WHERE id = :id', [':id' => $this->tagId]);
    ...
    public function testASecondTagOnTheSameCourseDoesNotDuplicateIt(): void
    {
        ...
        try {
            ...
            $this->db->exec('DELETE FROM tags WHERE id = :id', [':id' => $second]);
        }
    }
