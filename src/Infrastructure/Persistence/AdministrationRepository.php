...
SQL);
    ...
    /** The same predicate for a query that has no WHERE clause of its own yet. */
...
SQL);
    ...
    /** @return list<array<string,mixed>> */
    public function courseReport(DataUniverse $universe): array
    {
        $courseScope = self::whereScope($universe, 'c');
...
SQL);
    ...
    /** @return list<array<string,mixed>> */
    public function companyReport(DataUniverse $universe): array
    {
