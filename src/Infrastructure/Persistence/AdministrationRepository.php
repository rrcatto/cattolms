...
Date time: 2026/08/21 01:00 SAST
...
SQL);
     ...
     */
    public function people(int $limit, int $offset): array
    {
        $sql = <<<'SQL'
SELECT
    u.id,
...
SQL;
        ...
        return $this->db->exec($sql . $this->limitOffset($limit, $offset));
    }
     ...
     * @return list<array<string,mixed>>
     */
    public function companies(int $limit, int $offset): array
    {
        $sql = <<<'SQL'
SELECT c.*,
...
SQL;
    ...
    {
        $rows = $this->db->exec('SELECT COUNT(*)::int AS total FROM companies');
        return (int) ($rows[0]['total'] ?? 0);
    }
     ...
     * @return list<array<string,mixed>>
     */
    public function enrolments(int $limit, int $offset): array
    {
        return $this->db->exec(
     ...
     */
    public function enrolmentsCount(): int
    {
        $rows = $this->db->exec(
            'SELECT COUNT(*)::int AS total
             FROM course_enrolments ce
     ...
     * @return list<array<string,mixed>>
     */
    public function requests(int $limit, int $offset): array
    {
        return $this->db->exec(
     ...
     * @return list<array<string,mixed>>
     */
    public function creditLedger(int $limit, int $offset): array
    {
        return $this->db->exec(
     ...
     */
    public function creditLedgerCount(): int
    {
        $rows = $this->db->exec(
            'SELECT COUNT(*)::int AS total
             FROM course_credits cc
    ...
    /** @return list<array<string,mixed>> */
    public function companyPeople(int $companyId, int $limit, int $offset): array
    {
        return $this->db->exec(
     ...
     * to remove.
     */
    public function companyPeopleCount(int $companyId): int
    {
        $rows = $this->db->exec(
            'SELECT COUNT(*)::int AS total
             FROM company_users cu
    ...
    /** @return list<array<string,mixed>> */
    public function companyRequests(int $companyId, int $limit, int $offset): array
    {
        return $this->db->exec(
            'SELECT cr.*,c.title AS course_title,c.slug,
                    COALESCE(NULLIF(trim(concat_ws(\' \',u.first_name,u.last_name)),\'\'),u.display_name,ue.email) AS learner_name,
    ...
    public function companyRequestsCount(int $companyId): int
    {
        $rows = $this->db->exec(
            'SELECT COUNT(*)::int AS total
             FROM course_requests cr
    ...
    /** @return list<array<string,mixed>> */
    public function companyEnrolments(int $companyId, int $limit, int $offset): array
    {
        return $this->db->exec(
            'SELECT ce.id,ce.public_id,ce.status,ce.assigned_at,ce.started_at,ce.expires_at,ce.completed_at,
     ...
     */
    public function companyEnrolmentsCount(int $companyId): int
    {
        $rows = $this->db->exec(
            'SELECT COUNT(*)::int AS total
             FROM course_enrolments ce
    ...
    /** @return list<array<string,mixed>> */
    public function companyCredits(int $companyId, int $limit, int $offset): array
    {
        return $this->db->exec(
    ...
    public function companyCreditsCount(int $companyId): int
    {
        $rows = $this->db->exec(
            'SELECT COUNT(*)::int AS total
             FROM course_credits cc
     ...
     * @return list<array<string,mixed>>
     */
    public function activity(array $filters = [], int $limit = 250, int $offset = 0): array
    {
