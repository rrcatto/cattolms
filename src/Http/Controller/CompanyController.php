...
final class CompanyController extends BaseController
{
    ...
    public function picker(): void
    {
        ...
        $data = $this->platformAdministration->companyPicker(self::pickerUniverse(), $_GET)
     ...
     *
     * A deliberate choice rather than the request scope: ALL unless the reader narrows it with the
     * picker's own control. The universe is an outcome of the selection here, not a filter on it.
     */
    private static function pickerUniverse(): DataUniverse
    {
        return match (strtolower(trim((string) ($_GET['picker_universe'] ?? '')))) {
    ...
    private function companySelectorView(CurrentUser $user): array
    {
        ...
        return [
            ...
            'company_switcher' => $canSelect
                ? $this->platformAdministration->companyPicker(self::pickerUniverse(), [])
                : null,
        ];
    }
