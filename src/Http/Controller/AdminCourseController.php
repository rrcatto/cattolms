...
final class AdminCourseController extends BaseController
{
    ...
    {
        $user = $this->requirePermission('COURSES.ADMIN.VIEW');
        $section = $this->adminSections->get('courses');
        $courses = $this->courses->adminCourses($user->id, $user->hasRole('ADMIN'));
        $this->render('admin-section', [
            'title' => 'Course administration',
            'page_title' => 'Courses',
            'page_kicker' => $user->hasRole('ADMIN') ? 'Platform administration' : 'Course authoring',
    ...
    {
        $this->requireCsrf();
        $user = $this->requirePermission('COURSES.CREATE');
    ...
    {
        $user = $this->requirePermission('COURSES.EDIT');
        ...
        $people = [];
        $companies = [];
        if ($user->hasPermission('COURSES.OWNERSHIP.MANAGE')) {
    ...
    {
        $user = $this->requirePermission('COURSES.PREVIEW');
    ...
    {
        $this->requirePermission('COURSES.PREVIEW');
        $courseId = $this->courseId();
        $this->requireManagedCourse($courseId);
    ...
    {
        $user = $this->requirePermission('COURSES.CERTIFICATES.MANAGE');
        $course = $this->requireManagedCourse($this->courseId());
    ...
    {
        $this->requireCsrf();
        $user = $this->requirePermission('COURSES.OWNERSHIP.MANAGE');
        $courseId = $this->courseId();
        $this->requireManagedCourse($courseId);
        $this->handle(function () use ($user, $courseId): void {
    ...
    {
        $this->requireCsrf();
        $user = $this->requirePermission('COURSES.PRICING.MANAGE');
        $courseId = $this->courseId();
        $this->requireManagedCourse($courseId);
        $this->handle(function () use ($user, $courseId): void {
    ...
    {
        $this->requireCsrf();
        $user = $this->requirePermission('COURSES.PUBLISH');
        $courseId = $this->courseId();
        $this->requireManagedCourse($courseId);
        $this->handle(function () use ($user, $courseId): void {
    ...
    {
        $this->requireCsrf();
        $user = $this->requirePermission('COURSES.ASSESSMENTS.MANAGE');
        $courseId = $this->courseId();
        $this->requireManagedCourse($courseId);
        $moduleId = $this->moduleId();
        $this->handle(function () use ($user, $courseId, $moduleId): void {
    ...
    {
        $this->requirePermission('COURSES.ASSESSMENTS.MANAGE');
        $course = $this->requireManagedCourse($this->courseId());
    ...
    {
        $this->requirePermission('COURSES.IMPORT');
    ...
    public function previewImport(): void
    {
        ...
        $this->handle(function () use ($key): void {
            ...
            $replaceable = array_values(array_filter(
                $this->courses->adminCourses(),
                fn(array $course): bool => !$this->portability->hasStartedLearners((int) $course['id'])
                    && ($user->hasRole('ADMIN') || (int) ($course['owner_user_id'] ?? 0) === $user->id)
            ));
    ...
    {
        $this->requireCsrf();
        $user = $this->requirePermission('COURSES.IMPORT');
    ...
    {
        $this->requireCsrf();
        $user = $this->requirePermission('COURSES.MEDIA.MANAGE');
        $courseId = $this->courseId();
        $this->requireManagedCourse($courseId);
        $this->handle(function () use ($user, $courseId): void {
    ...
    {
        $this->requirePermission('COURSES.EXPORT');
        $courseId = $this->courseId();
        $course = $this->requireManagedCourse($courseId);
    ...
    {
        $this->requireCsrf();
        $user = $this->requirePermission('COURSES.DELETE');
        $courseId = $this->courseId();
        $this->requireManagedCourse($courseId);
        $this->handle(function () use ($user, $courseId): void {
    ...
    private function requireManagedCourse(int $courseId): array
    {
        $user = $this->requireUser();
        $course = $this->courses->adminCourse($courseId);
        if (!$user->hasRole('ADMIN') && !$this->courses->userCanManageCourse($courseId, $user->id)) {
