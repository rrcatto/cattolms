...
final class CourseController extends BaseController
{
    ...
    public function catalogue(): void
    {
        ...
        $pagination = Pagination::create($_GET['page'] ?? null, $_GET['page_size'] ?? null, $this->courses->catalogueCount($this->universe()));
        $courses = $this->courses->catalogue($this->universe(), $pagination->pageSize, $pagination->offset);
        $favouriteIds = [];
        $requestStatus = [];
        if ($user !== null) {
        ...
        $this->render('courses', [
            ...
            'courses' => $courses,
            'catalogue_pagination' => $pagination->toArray() + [
                'prefix' => 'catalogue',
                'page_param' => 'page',
