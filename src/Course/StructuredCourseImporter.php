...
final class StructuredCourseImporter
{
    ...
    private function assessment(?array $input, string $type, string $defaultTitle): ?array
    {
        ...
        $practicePoolMode = in_array((string) ($input['practice_pool_mode'] ?? 'both'), ['separate','graded','both'], true)
            ...
            : 'both';
        $gradedEligible = array_values(array_filter($questions, static fn(array $question): bool => (bool) $question['graded_eligible']));
        ...
        $practiceEligible = array_values(array_filter($questions, static function (array $question) use ($practicePoolMode): bool {
