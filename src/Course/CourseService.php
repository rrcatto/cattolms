...
final class CourseService
{
     ...
     */
    public function catalogue(int $limit = 25, int $offset = 0): array
    {
        return $this->decorateCatalogue($this->courses->publishedCourses($limit, $offset));
    }

    /** Total published courses, for the catalogue's "Showing X-Y of Z" contract. */
    public function catalogueCount(): int
    {
        return $this->courses->publishedCoursesCount();
    }
