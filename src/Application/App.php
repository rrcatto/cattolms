        ...
        $f3->set('ONERROR', static function (Base $f3) use ($container): void {
            ...
            try {
                ...
                echo $view->render('error', [
                    ...
                    'is_platform_admin' => $currentUser?->hasRole('ADMIN') ?? false,
                    'is_company_admin' => $currentUser?->hasRole('COMPANY_ADMIN') ?? false,
                    'is_course_owner' => $currentUser?->hasRole('COURSE_OWNER') ?? false,
                    'is_course_editor' => $currentUser?->hasRole('COURSE_EDITOR') ?? false,
